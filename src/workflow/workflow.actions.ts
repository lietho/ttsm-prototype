...
export const acceptAdvanceWorkflowInstance = createConsistencyMessage<{ workflowInstanceConsistencyId: string, newState: StateValue }>('[Workflow] Accept advance workflow instance');
export const rejectAdvanceWorkflowInstance = createConsistencyMessage<{ workflowInstanceConsistencyId: string, fromState: StateValue, transitionEvent: string, errorMessage: string }>('[Workflow] Reject advance workflow instance');
